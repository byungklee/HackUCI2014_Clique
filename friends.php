...
<img src= <?php if($_SESSION['picture_url'] == NULL) { echo '"images/profile_pic.jpg"'; } else echo '"'.$_SESSION['picture_url'].'"'; ?> class="img-responsive" alt="50x50" src="data:image/svg+xml;base64,"></div>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h4>You have <b>4</b> friend requests!</b></h4>
            <a href="friendrequest.php">Click Here For More Details</a>
<!--             <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
 -->            
                <div class="row placeholders"><br>
                  <div class="col-xs-6 col-sm-3 placeholder">
                    ...
                    <h4>Byung Lee</h4>
                    <span class="text-muted">Computer Science | Irvine, CA</span>
                  </div>
                  <div class="col-xs-6 col-sm-3 placeholder">
                  ...
                  <div class="col-xs-6 col-sm-3 placeholder">
                    <img data-src="holder.js/200x200/auto/sky" class="img-responsive" alt="200x200" src="data:image/svg+xml;base64,">
                    <h4>Jose J. Mora</h4>
                    <span class="text-muted">Political Science | La Puente, CA</span>
                  </div>
                  <div class="col-xs-6 col-sm-3 placeholder">
                    <img data-src="holder.js/200x200/auto/vine" class="img-responsive" alt="200x200" src="data:image/svg+xml;base64,">
                    <h4>Hee Hwang</h4>
                    <span class="text-muted">Computer Science | Newport Beach, CA</span>
                  </div>
            </div>
        </div>
      </div>
